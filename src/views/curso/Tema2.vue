    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.overflow-hidden
      ...
      .row.mb-5
        ...
        .col-lg-8
          ...
          p(data-aos="fade-left")  Las brigadas de emergencia, son componentes esenciales en la gestión de la seguridad y salud en el trabajo, dado que su principal objetivo es el de garantizar la protección de los trabajadores ante situaciones de riesgo, emergencias o desastres. Estas brigadas están diseñadas para responder de manera rápida y efectiva a cualquier incidente que pueda poner en peligro la vida y la integridad física de las personas en el entorno laboral. En Colombia, la formación y establecimiento de brigadas de emergencia, se encuentra regulada dentro de un marco normativo que busca promover la prevención y la preparación ante posibles eventualidades.
